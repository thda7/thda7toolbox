...
var Chartkick = {
  ...
  eachChart: function(callback) {
    for (var chartId2 in Chartkick.charts) {
      if (Object.prototype.hasOwnProperty.call(Chartkick.charts, chartId2)) {
        callback(Chartkick.charts[chartId2]);
      }
    }
  },
  destroyAll: function() {
    for (var chartId2 in Chartkick.charts) {
      if (Object.prototype.hasOwnProperty.call(Chartkick.charts, chartId2)) {
        Chartkick.charts[chartId2].destroy();
        delete Chartkick.charts[chartId2];
      }
    }
  },
  config: {},
