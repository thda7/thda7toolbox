...
<!-- L31-48: rendern geht wunderbar, aber v-model wird nicht gebindet.-->
    ...
    <v-card flat class="mx-auto mb-6" width="600px">
      ...
      >
        <v-text-field v-model="radius"
          label="Tablet's Convexity Radius R"
          m
          hide-details="auto"
          hint=""
          placeholder="Enter Convexity Radius R"
          suffix="[mm]"
    ...
    flat
    tile>
      <v-btn large small text color="green lighten-3" v-on:click="calcStripCavity('round_convex')" >
...
export default {
  ...
  data(){
    return {
      ...
      PL: '',
      w_foil: '',
      shape: 'round_convex', // QUESTION: wird fuer calcStripCavity in der if Schleife ueberprueft
